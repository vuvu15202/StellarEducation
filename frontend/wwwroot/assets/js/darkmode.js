...
darkModeCustom(isDarkMode);
function darkModeCustom(isDarkMode) {
    const dark_version = document.getElementById("dark-version");
    dark_version.setAttribute("checked", isDarkMode); 
    ...
    if (isDarkMode) {
        ...
        dark_version.setAttribute("checked", "true");
    } else {
        ...
        dark_version.removeAttribute("checked");
    }
};